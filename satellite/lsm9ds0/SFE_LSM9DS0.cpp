...
//LSM9DS0 dof(MODE_I2C_lsm0, LSM9DS0_G, LSM9DS0_XM);



//LSM9DS0::LSM9DS0(interface_mode_lsm0 interface, uint8_t gAddr, uint8_t xmAddr)
//{
...
//                        gyro_odr gODR, accel_odr aODR, mag_odr mODR, const char * path)
//{
...
//    if (interfaceMode == MODE_I2C_lsm0)	// If we're using I2C
//        initI2C(path);					// Initialize I2C
...
//    if (interfaceMode == MODE_I2C_lsm0)
...
//void LSM9DS0::initI2C(const char* path)
//{
...
//    uint8_t addr_data[2];
//    addr_data[0] = subAddress;
//    addr_data[1] = data;

//    i2c_write_buff(file, address, (uint8_t*)&addr_data, 2);
//}
...
//    uint8_t data;
//    i2c_read_buff(file, address, subAddress, (uint8_t*)&data,1);
//    return data;
//}
...
////	}
////    uint8_t * ptr =(uint8_t*) malloc(sizeof(uint8_t) * count);
//    for(int i =0; i < count; i++){
//        dest[i] = I2CreadByte(address, subAddress + i);
//    }
