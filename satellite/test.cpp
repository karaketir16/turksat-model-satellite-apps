...
void printGyro()
{
  ...
  qDebug() << dof.calcGyro(dof.gx) << ", " << dof.calcGyro(dof.gy) << ", " << dof.calcGyro(dof.gz);
#elif defined PRINT_RAW
  qDebug() << dof.gx<< ", " << dof.gy << ", " << dof.gz;
#endif
}
...
void printAccel()
{
  ...
  qDebug() << dof.calcAccel(dof.ax) << ", " << dof.calcAccel(dof.ay) << ", " << dof.calcAccel(dof.az);
#elif defined PRINT_RAW
  qDebug() << dof.ax << ", " << dof.ay << ", " << dof.az;
#endif
...
void printMag()
{
  ...
  qDebug() << dof.calcMag(dof.mx) << ", " << dof.calcMag(dof.my)  << ", " << dof.calcMag(dof.mz);
#elif defined PRINT_RAW
  qDebug() << dof.mx << ", " << dof.my << ", " << dof.mz;
#endif
}
