...
public:
    ...
    uint16_t begin(uint8_t agAddress = LSM9DS1_AG_ADDR(1) * 2, uint8_t mAddress = LSM9DS1_M_ADDR(1) * 2, const char* path = "/dev/i2c-1"); //By default use the default I2C addres, and use Wire port
